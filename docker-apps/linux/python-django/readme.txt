...
docker image build -t n4demo/python-django:my-name-here .

# run the local image
docker container run --name python_django -it --rm  -p 80:80 n4demo/python-django:my-name-here
...
docker push n4demo/python-django:my-name-here