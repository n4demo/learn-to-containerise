...
# Note: n4demo refers to the repository, nodejs refers to the application and my-name-here is the tag for this application. 
# the dot refers to the current directory

docker image build -t n4demo/nodejs .

# run the local image
docker run -it --rm  --name nodejs -p 5013:8080 n4demo/nodejs
